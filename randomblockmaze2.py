...
def returncoll(tank, walls):
    ...
    for wall in walls:
        print(type(tank))
        if tank.y > wall.dim[1] and tank.y < wall.dim[1] + wall.dim[2] or tank.y + 64 > wall.dim[1] and tank.y + 64 < wall.dim[1] + wall.dim[2]:
            if tank.x > wall.dim[0] and tank.x < wall.dim[0] + wall.dim[3] or tank.x + 64 > wall.dim[3] and tank.x + 64 < wall.dim[0] + wall.dim[3]:
